...
#define LCD_LAY1_ADRESS		   (LCD_FRAME_BUFFER+BUFFER_OFFSET)
#define BUFFER_OFFSET_LAY1	   ((uint32_t)(320*240)//76800*4=0x4B000 //0x12C00

#define LCD_LAY2_ADRESS		   ((uint32_t)LCD_LAY1_ADRESS+BUFFER_OFFSET)
#define BUFFER_OFFSET_LAY2	   ((uint32_t)(320*240)
...
void paintSymvol(uint32_t LayerIndex, void * pDst, void * p);
